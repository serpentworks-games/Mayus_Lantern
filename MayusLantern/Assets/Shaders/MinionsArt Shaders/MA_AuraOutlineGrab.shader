...
Shader "MinionsArt/FX/Aura Outline Grab" {
	Properties{
		[Header(Aura)]
...
#include "UnityCG.cginc"
		...
		ENDCG
			...
			UsePass "Custom/GhostEffect Grab/Grab"// Grab Pass
			UsePass "Custom/GhostEffect Grab/FORWARD" // Base shader pass, using the standard ToonLit shader
