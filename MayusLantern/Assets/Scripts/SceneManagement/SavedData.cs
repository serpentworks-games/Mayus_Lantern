    ...
    public class SavedData : MonoBehaviour
    {
        public static SavedData Instance
        {
            get
            {
                ...
                GameObject saveManagerGameObject = new GameObject("SaveManager");
                instance = saveManagerGameObject.AddComponent<SavedData>();
        ...
        {
            if (Instance.m_StringSavedData.TryGetValue(key, out value)) return value;
        ...
        {
            if (Instance.m_BoolSavedData.TryGetValue(key, out value)) return value;
        ...
        {
            if (Instance.m_IntSavedData.TryGetValue(key, out value)) return value;
        ...
        {
            if (Instance.m_FloatSavedData.TryGetValue(key, out value)) return value;
        ...
        {
            if (Instance.m_Vector2SavedData.TryGetValue(key, out value)) return value;
