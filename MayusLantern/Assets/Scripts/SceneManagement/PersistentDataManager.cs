namespace ML.SceneManagement
{
    ...
    public class PersistentDataManager : MonoBehaviour {
        ...
        public static PersistentDataManager Create(){
            GameObject dataManagerGameObject = new GameObject("Persistent Data Manager");
        ...
        protected void SaveAllDataInteral(){
        ...
        protected void Save(IDataPersister dp){
            ...
            if (dataSettings.persistenceType == DataSettings.PersistenceType.ReadOnly || dataSettings.persistenceType == DataSettings.PersistenceType.DoNoPersist)
                return;
        ...
        protected void LoadAllDataInternal(){
            schedule += () =>
            {
                foreach (var dp in m_DataPersisters)
                {
                    ...
                    if (dataSettings.persistenceType == DataSettings.PersistenceType.WriteOnly || dataSettings.persistenceType == DataSettings.PersistenceType.DoNoPersist)
                        continue;
